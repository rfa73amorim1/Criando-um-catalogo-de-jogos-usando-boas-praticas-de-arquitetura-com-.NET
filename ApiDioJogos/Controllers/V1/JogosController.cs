...
using ApiDioJogos.ViewModel;
using ApiDioJogos.InputModel;
using ApiDioJogos.Services;
using ApiDioJogos.Exceptions;

namespace ApiDioJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="pagina">Indica a página que está sendo consultada</param>
        /// <param name="quantidade">Indica a quantidade de registros por página (mínimo 1 e máximo 50 registros) </param>
        ...
        /// <response code="200">Para jogo excluído com sucesso</response>
        /// <response code="404">Caso não exista um jogo com este Id</response>
        ///  <returns></returns>
